...
// 或者为文字单独创建一个更稳定的粒子系统
const textParticles = new ParticleSystem({
  duration: 8,
  looping: true,
  startLife: new ConstantValue(7),
  startSpeed: new ConstantValue(0),
  startSize: new ConstantValue(0.08), // 固定大小
  startColor: new ConstantValue(new Vector4(1, 1, 1, 1)), // 固定白色
  emissionOverTime: new ConstantValue(0),
  emissionBursts: [
    {
      time: 0,
